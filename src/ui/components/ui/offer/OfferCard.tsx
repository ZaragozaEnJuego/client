  ...
  return (
    ...
    >
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 style={{ color: chooseColor('transport') }} className={'w-50 font-bold text-xl'}>
          {offer.amount}€
        </h1>
      </div>
      <div className='flex items-center justify-top mt-4 mx-4 flex-col'>
        ...
        <div className='flex flex-col items-center px-5 py-1 w-full'>
          <button
            className='items-center text-xs text-primary py-1 my-1 w-20 rounded-lg mx-2 bg-green-nord'
            onClick={() => {
